...
const Referrals: React.FC = () => {
    ...
    const isTransactionHoldPosition = (t: Transaction) => {
        ...
        // Check for specific keywords typically set by the backend for auto-upgrade holds
                ...
                <div className="p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex flex-col items-end gap-1 w-full sm:w-auto text-right pl-9 sm:pl-0">
                        ...
                        {(held > 0 || isHoldPosition) && !isHeldView && (
                             <div className={`${isHoldPosition ? 'bg-amber-100 border-amber-300' : 'bg-blue-50 border-blue-100 dark:bg-blue-900/20 dark:border-blue-800'} px-3 py-1 rounded border shadow-sm`}>
