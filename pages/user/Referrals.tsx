    ...
    const heldCommissionsData = useMemo(() => {
        ...
        transactions.filter(t => t.userId === currentUser._id && t.type === 'Commission' && t.status === 'Pending' && (t.relatedPlanId ? filterIds.has(String(t.relatedPlanId)) : true))
            .forEach(t => {
                ...
                let reason = isTransactionHoldPosition(t) ? "Hold Commission for upgrade" : "Pending Requirement";
    ...
    return (
        <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                    <p className="text-xs text-amber-600 uppercase font-bold">Held for Upgrade</p>
