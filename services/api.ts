...
export const getDataVersion = async (): Promise<number> => {
    try {
        const response = await fetch(`${API_BASE_URL}/settings/version`, { headers: getHeaders() });
...
export const getDeposits = async (): Promise<Deposit[]> => {
    const response = await fetch(`${API_BASE_URL}/deposits`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getWithdrawals = async (): Promise<Withdrawal[]> => {
    const response = await fetch(`${API_BASE_URL}/withdrawals`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getTransactions = async (): Promise<Transaction[]> => {
    const response = await fetch(`${API_BASE_URL}/transactions`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getPaymentMethods = async (): Promise<PaymentMethod[]> => {
    const response = await fetch(`${API_BASE_URL}/payment-methods`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getInvestmentPlans = async (): Promise<InvestmentPlan[]> => {
    const response = await fetch(`${API_BASE_URL}/investment-plans`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getTransfers = async (): Promise<Transfer[]> => {
    const response = await fetch(`${API_BASE_URL}/transfers`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getPasswordResetRequests = async (): Promise<PasswordResetRequest[]> => {
    const response = await fetch(`${API_BASE_URL}/password-reset-requests`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getDisputes = async (): Promise<Dispute[]> => {
    const response = await fetch(`${API_BASE_URL}/disputes`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
...
export const getPendingTaskVerifications = async (): Promise<any[]> => {
    const response = await fetch(`${API_BASE_URL}/tasks/pending-verifications`, { headers: getHeaders() });
    const result = await handleResponse(response);
    return result.data;
};
