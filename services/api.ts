...
export const adminRemoveUserPlan = async (userId: string, planInstanceId: string): Promise<User> => {
    const response = await fetch(`${API_BASE_URL}/users/${userId}/plans/${planInstanceId}`, { method: 'DELETE' });
    const result = await handleResponse(response);
    return result.data;
};

export const upgradeUserFromHold = async (userId: string, fromPlanId: string, adminUsername: string): Promise<User> => {
    const response = await fetch(`${API_BASE_URL}/users/upgrade-from-hold`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
export const adjustUserWallet = async (id: string, data: any) => {
...
export const purchasePlan = async (userId: string, planId: string) => {
...
export const adminActivatePlan = async (userId: string, planId: string) => {
...
export const sendAdminNotification = async (notifData: any): Promise<{ count: number; data: Notification[] }> => {
    const response = await fetch(`${API_BASE_URL}/notifications`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
export const bulkUpdateUserRestrictions = async (data: any) => {
